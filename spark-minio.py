...
def load_config(spark_context: SparkContext):
    ...
    spark_context._jsc.hadoopConfiguration().set("fs.s3a.access.key", "IgXyAEVlEPqQb1gSpSku")
    spark_context._jsc.hadoopConfiguration().set("fs.s3a.secret.key","9jsPZ8sIawSbXlETR4uiuqKCAmIKCnctIAeGtfYc")
